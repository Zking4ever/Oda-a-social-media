    ...
    <main>
        <div id="menu">
            <div class="menuLists">
                ...
                <label for="home_radio">Friends</label>
                <label for="home_radio">Thoughts</label>
                <label for="home_radio">Ask Me</label>
                <label for="home_radio">Councelor</label>
                <label for="home_radio">Setting</label>
            </div>
        </div>
        <div id="body">
            <div class="stroies">
                    <div class="story mystory">
                        <label for="story_img">
                                <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" class="bi bi-plus-circle-dotted" viewBox="0 0 16 16">
                    ...
                    <div class="options" style="display: none;">
                        ...
                        <div class="profile">
                            <div class="profile_img">
                                ...
                                <label for="change_profile" id="change_profile_lable" title="change profile image">
